...
DEV_CSV = "datasets/MELD/dev_meld_emo.csv"
REASONING_JSONL = "outputs/prompts/meld_dev_reasoning_qwen7b.jsonl"
OUT_CSV = "datasets/MELD/dev_meld_emo_augmented.csv"
...
def main():
    ...
    with open(DEV_CSV, "r", encoding="utf-8") as fin:
